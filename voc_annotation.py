...
classes_path        = '/project/train/src_repo/plate_detection/model_data/class.txt'
trainval_percent    = 1
train_percent       = 0.6
...
def convert_annotation(year, image_id, list_file):
    in_file = open('/home/data/782/%s.xml'%(image_id), encoding='utf-8')
...
if __name__ == "__main__":
    ...
    if annotation_mode == 0 or annotation_mode == 1:
        ...
        xmlfilepath     = "/home/data/782"
        saveBasePath    = "/project/train/src_repo/plate_detection/Main"
    ...
    if annotation_mode == 0 or annotation_mode == 2:
        ...
        for year, image_set in VOCdevkit_sets:
            image_ids = open('/project/train/src_repo/plate_detection/Main/%s.txt'%(image_set), encoding='utf-8').read().strip().split()
            list_file = open('/project/train/src_repo/plate_detection/%s_%s.txt'%(year, image_set), 'w+', encoding='utf-8')
            for image_id in image_ids:
                list_file.write("/home/data/782/%s.jpg"%(image_id))
