...
if __name__ == "__main__":
    ...
    #---------------------------------------------------------------------#
    anchors_path    = '/project/train/src_repo/plate_detection/model_data/yolo_anchors.txt'
    ...
    train_annotation_path = '/project/train/src_repo/plate_detection/2007_train.txt'
    val_annotation_path = '/project/train/src_repo/plate_detection/2007_val.txt'
    #----------------------------------------------------#
    #   获取classes和anchor
    #----------------------------------------------------#
    ...
    loss_history = LossHistory("/project/train/src_repo/plate_detection/logs","plate")
